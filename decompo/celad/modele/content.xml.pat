...
<office:document-content xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:rpt="http://openoffice.org/2005/report" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:officeooo="http://openoffice.org/2009/office" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:drawooo="http://openoffice.org/2010/draw" xmlns:calcext="urn:org:documentfoundation:names:experimental:calc:xmlns:calcext:1.0" xmlns:loext="urn:org:documentfoundation:names:experimental:office:xmlns:loext:1.0" xmlns:field="urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0" xmlns:formx="urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0" xmlns:css3t="http://www.w3.org/TR/css3-text/" office:version="1.2">
	...
	<office:automatic-styles>
		<style:style style:name="Tableau1" style:family="table">
			<style:table-properties style:width="16.383cm" fo:margin-left="-0.199cm" table:align="left" style:writing-mode="lr-tb"/>
		</style:style>
		...
		<style:style style:name="Tableau1.A2" style:family="table-cell">
			<style:table-cell-properties style:vertical-align="top" fo:padding-left="0.191cm" fo:padding-right="0.191cm" fo:padding-top="0cm" fo:padding-bottom="0cm" fo:border-left="0.5pt solid #000000" fo:border-right="none" fo:border-top="0.5pt solid #000000" fo:border-bottom="none" style:writing-mode="lr-tb"/>
		</style:style>
		...
		<style:style style:name="Tableau3.B" style:family="table-column">
			<style:table-column-properties style:column-width="10.918cm"/>
		</style:style>
		...
		<style:style style:name="P1" style:family="paragraph" style:parent-style-name="Standard">
			<style:text-properties fo:color="#333399" fo:font-size="14pt" fo:font-weight="bold" style:font-size-asian="14pt" style:font-weight-asian="bold" style:font-weight-complex="bold"/>
		</style:style>
		...
		<style:style style:name="P8" style:family="paragraph" style:parent-style-name="Standard">
			<style:paragraph-properties style:snap-to-layout-grid="false"/>
			<style:text-properties fo:font-size="10pt" fo:language="fr" fo:country="FR" style:font-size-asian="10pt" style:language-asian="fr" style:country-asian="FR"/>
		</style:style>
		...
		<style:style style:name="P10" style:family="paragraph" style:parent-style-name="Standard">
			<style:paragraph-properties fo:margin-left="0.73cm" fo:margin-right="0cm" fo:text-align="center" style:justify-single-word="false" fo:text-indent="0cm" style:auto-text-indent="false"/>
			<style:text-properties style:font-size-complex="18pt"/>
		</style:style>
		<style:style style:name="P11" style:family="paragraph" style:parent-style-name="Standard" style:master-page-name="Convertir_20_1">
		...
		<style:style style:name="P18" style:family="paragraph" style:parent-style-name="Footer">
			<style:paragraph-properties style:snap-to-layout-grid="false"/>
			<style:text-properties fo:color="#333399" fo:font-style="italic" style:font-style-asian="italic" style:font-style-complex="italic"/>
		</style:style>
		...
		<style:style style:name="fr1" style:family="graphic" style:parent-style-name="Graphics">
			<style:graphic-properties fo:margin-left="0.319cm" fo:margin-right="0.319cm" style:wrap="parallel" style:number-wrapped-paragraphs="no-limit" style:wrap-contour="false" style:vertical-pos="from-top" style:vertical-rel="paragraph" style:horizontal-pos="from-left" style:horizontal-rel="paragraph" fo:padding="0.002cm" fo:border="none" style:mirror="none" fo:clip="rect(0cm, 0cm, 0cm, 0cm)" draw:luminance="0%" draw:contrast="0%" draw:red="0%" draw:green="0%" draw:blue="0%" draw:gamma="100%" draw:color-inversion="false" draw:image-opacity="100%" draw:color-mode="standard"/>
		</style:style>
		<style:style style:name="fr2" style:family="graphic" style:parent-style-name="Graphics">
			<style:graphic-properties fo:margin-left="0cm" fo:margin-right="0cm" style:vertical-pos="top" style:vertical-rel="baseline" fo:padding="0.002cm" fo:border="none" style:mirror="none" fo:clip="rect(0cm, 0cm, 0cm, 0cm)" draw:luminance="0%" draw:contrast="0%" draw:red="0%" draw:green="0%" draw:blue="0%" draw:gamma="100%" draw:color-inversion="false" draw:image-opacity="100%" draw:color-mode="standard"/>
		</style:style>
		<style:style style:name="fr3" style:family="graphic" style:parent-style-name="Graphics">
			<style:graphic-properties fo:margin-left="0.319cm" fo:margin-right="0.319cm" style:run-through="background" style:wrap="run-through" style:number-wrapped-paragraphs="no-limit" style:vertical-pos="from-top" style:vertical-rel="paragraph" style:horizontal-pos="from-left" style:horizontal-rel="page-content" fo:padding="0.002cm" fo:border="none" style:mirror="none" fo:clip="rect(0cm, 0cm, 0cm, 0cm)" draw:luminance="0%" draw:contrast="0%" draw:red="0%" draw:green="0%" draw:blue="0%" draw:gamma="100%" draw:color-inversion="false" draw:image-opacity="100%" draw:color-mode="standard"/>
		</style:style>
	</office:automatic-styles>
	<office:body>
			...
			<table:table table:name="Tableau2" table:style-name="Tableau2">
				...
				<table:table-row table:style-name="Tableau2.1">
					<table:table-cell table:style-name="Tableau2.A1" office:value-type="string">
						<text:p text:style-name="P1">CONNAISSANCES TECHNIQUES</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row table:style-name="Tableau2.1">
			...
			<table:table table:name="Tableau3" table:style-name="Tableau3">
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Systèmes</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Matériels</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Langages</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Serveurs d’applications</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Réseaux</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Noyau Temps réel</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Bases de données</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Méthodologies</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Outils</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Autres (préciser)</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="P2"/>
					</table:table-cell>
				...
				<table:table-row table:style-name="Tableau3.1">
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
						<text:p text:style-name="Thème_20_CT">Anglais</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tableau3.A1" office:value-type="string">
			...
			<table:table table:name="Tableau4" table:style-name="Tableau4">
				...
				<table:table-row table:style-name="Tableau4.1">
					<table:table-cell table:style-name="Tableau4.A1" office:value-type="string">
						<text:p text:style-name="P1">EXPÉRIENCES ET PRINCIPALES RÉALISATIONS</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row table:style-name="Tableau4.1">
...
<?php if(0){ ?>
			...
			<table:table table:name="Tableau5" table:style-name="Tableau5">
				...
				<table:table-row table:style-name="Tableau5.1">
					<table:table-cell table:style-name="Tableau5.A1" office:value-type="string">
						<text:p text:style-name="Standard">
							<text:span text:style-name="T3">PROJETS D’ÉTUDES</text:span>
							<text:span text:style-name="T2"> </text:span>
							<text:span text:style-name="T1">(hors stages, si moins de 2/3 ans d’expérience)</text:span>
						</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row table:style-name="Tableau5.1">
			...
			<text:p text:style-name="P4"/>
			<text:p text:style-name="P4"/>
			<text:h text:style-name="P16" text:outline-level="5">Durée à Ecole/Université 
				<text:s/>– Ville
			</text:h>
			<text:p text:style-name="P4"/>
			<text:p text:style-name="P4">Description du projet d’études et des différentes tâches effectuées :</text:p>
			<text:list xml:id="list184052861160002" text:continue-numbering="true" text:style-name="WW8Num2">
				<text:list-item>
					<text:p text:style-name="Taches"/>
				</text:list-item>
				<text:list-item>
